...
function init() {
  ...
  // 在这下面给add-btn绑定一个点击事件，点击时触发addBtnHandle函数
	...
	document.getElementById('aqi-value-input').onkeyup = function(e){
		if(e.keyCode == 13) addBtnHandle();
	}
  // 想办法给aqi-table中的所有删除按钮绑定事件，触发delBtnHandle函数
//	document.getElementById('aqi-table').getElementsByTagName('button').onclick = function(e){
//		console.log('del');
